...
export const insert_admin = {
    ...
    args:['admin', crypto.createHmac('sha256', CONFIG.key_code).update('admin').digest('hex'), 'admin', 'admin', 'admin', '0(000)000-00-00', 'admin@admin',1, 1, '{"roles":[]}', '{"user_data":[]}', '', false, '', false, null, dateTimeToSQL(new Date(Date.now())), '']
};